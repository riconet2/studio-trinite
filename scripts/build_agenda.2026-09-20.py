...
# --------------------------------------------------------------------------------------
LANG_KEYS = ("fr", "fr-FR", "fr_FR", "fra", "en", "en-GB", "en-US")
...
def dedupe(cands: list[dict], stats: Counter) -> list[dict]:
    ...
    for c in ordered:
        ...
        for field in ("end", "location", "description", "url", "distance_km"):
...
# Sortie
# --------------------------------------------------------------------------------------
PUBLIC_FIELDS = ["id", "title", "start", "end", "location", "city", "description", "url",
                 "category", "priority", "proximity", "source", "source_name", "distance_km"]
